...
public class and_identity_name_header_is_missing : given.a_valid_identity_request
{
    void Establish() => headers.Setup(_ => _.ContainsKey(MicrosoftIdentityPlatformHeaders.IdentityNameHeader)).Returns(false);
