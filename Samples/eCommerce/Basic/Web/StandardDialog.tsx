...
import { DialogResolver, StandardDialogRequest, useDialogContext } from '@cratis/applications.react.mvvm/dialogs'
...
export const StandardDialog = () => {
    ...
    return (
        <Dialog header={request.title} onHide={() => resolver(DialogResult.Cancelled)}>
